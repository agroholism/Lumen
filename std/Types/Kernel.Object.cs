...
namespace Lumen.Lang.Std {
	internal class ObjectClass : Record {
		internal ObjectClass() {
			...
			SetAttribute("get_null?", new LambdaFun((e, args) => new Bool(e.Get("this") is Void), "Kernel.Object.get_null?"));
